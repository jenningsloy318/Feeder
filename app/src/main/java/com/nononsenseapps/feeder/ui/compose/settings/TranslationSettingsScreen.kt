...
fun TranslationSettingsScreen(
    ...
    val translationTargetLanguage by viewModel.translationTargetLanguage.collectAsStateWithLifecycle()
    ...
    Scaffold(
        ...
        Column(
            ...
            LanguageSelectorSetting(
                ...
                onLanguageSelected = { viewModel.setTranslationTargetLanguage(it) },
